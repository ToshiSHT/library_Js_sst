...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-toggle="modal"]').modal(); //инициализация триггеров для открытия модальных окон
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.index = function () {
  // возвращает индек элемента среди его соседей
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.siblings = function () {
  // находим соседей не включая самого обьекта
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeInTehnic = function (dur, display, fin) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOutTehnic = function (dur, fin) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function () {
  let dur = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;
  let display = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'block';
  let fin = arguments.length > 2 ? arguments[2] : undefined;
  this.fadeInTehnic(dur, display, fin);
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function () {
  let dur = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;
  let fin = arguments.length > 1 ? arguments[1] : undefined;
  this.fadeOutTehnic(dur, fin);
  return this;
};
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function () {
  let dur = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;
  let display = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'block';
  let fin = arguments.length > 2 ? arguments[2] : undefined;
  for (let i = 0; i < this.length; i++) {
    if (window.getComputedStyle(this[i]).display == display) {
      this.fadeOutTehnic(dur, fin);
    } else {
      this.fadeInTehnic(dur, display, fin);
    }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
    ...
    btns: {
      count: 3,
      settings: [['1 кнопка', ['btn-primary'], false, () => alert('super')],
      // text class close? callback
      ['close', ['btn-warning', 'ml-10'], true, ''], ['super close', ['btn-dark', 'ml-10'], true, '']]
    }
  });
});
